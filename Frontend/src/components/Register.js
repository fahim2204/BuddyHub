...
const Register = () => {
    ...
    const OAuthRegistrationRequest = (user) => {
        axios.post(`${apiUrl}/oauth`, user)
            .then(res => {
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex flex-column">
                                    ...
                                    {/* <div className="d-flex justify-content-center mt-2">
                                        <button type="submit" onClick={DoRegistration} className="btn btn-success d-inline-block">Register</button>
                                    </div> */}
                                </div>
